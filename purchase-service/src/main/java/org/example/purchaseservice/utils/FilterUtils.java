...
public final class FilterUtils {
    ...
    private static final String FILTER_BUSINESS = "business";
    private static final String FILTER_ROUTE = "route";
    private static final String FILTER_REGION = "region";
    private static final String FILTER_CLIENT_PRODUCT = "clientProduct";
    ...
    private static final Set<String> STATUS_BUSINESS_ROUTE_REGION_KEYS = Set.of(
            FILTER_STATUS, FILTER_BUSINESS, FILTER_ROUTE, FILTER_REGION
    );
    
    private static final Set<String> COMMON_CLIENT_KEYS = Set.of(
            FILTER_CLIENT_PRODUCT, FILTER_CLIENT_SOURCE,
    ...
    public static Long extractClientTypeId(Map<String, List<String>> filterParams) {
        if (filterParams == null || !filterParams.containsKey(FILTER_CLIENT_TYPE_ID)) {
            return null;
        }
        
        List<String> clientTypeIdList = filterParams.get(FILTER_CLIENT_TYPE_ID);
        ...
        try {
            ...
            log.error("Invalid clientTypeId in filterParams: {}", clientTypeIdList, e);
            return null;
        }
    }
    ...
    private static boolean isClientFilterKey(String key, boolean includeStatusBusinessRouteRegion) {
        ...
        if (includeStatusBusinessRouteRegion && STATUS_BUSINESS_ROUTE_REGION_KEYS.contains(key)) {
            return true;
        }
