...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleClientException(@NonNull ClientException ex, @NonNull Locale locale) {
        String errorCode = ex.getErrorCode();
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Client error: code={}, message={}", errorCode, exceptionMessage);
        
        String messageKey = String.format(ErrorConstants.MESSAGE_KEY_PREFIX_CLIENT_ERROR, errorCode.toUpperCase());
    ...
    public ErrorResponse handleClientNotFoundException(@NonNull ClientNotFoundException ex, @NonNull Locale locale) {
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Client not found: {}", exceptionMessage);
        return new ErrorResponse(
                ErrorConstants.ERROR_CLIENT_NOT_FOUND,
                MessageLocalizationHelper.getLocalizedMessage(
                        messageSource, ErrorConstants.MESSAGE_KEY_CLIENT_NOT_FOUND,
    ...
    public ErrorResponse handleSourceException(@NonNull SourceException ex, @NonNull Locale locale) {
        String errorCode = ex.getErrorCode();
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Source error: code={}, message={}", errorCode, exceptionMessage);
    ...
    public ErrorResponse handleSourceNotFoundException(@NonNull SourceNotFoundException ex, @NonNull Locale locale) {
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Source not found: {}", exceptionMessage);
        return new ErrorResponse(
                ErrorConstants.ERROR_SOURCE_NOT_FOUND,
                MessageLocalizationHelper.getLocalizedMessage(
                        messageSource, ErrorConstants.MESSAGE_KEY_SOURCE_NOT_FOUND,
                        exceptionMessage, locale),
                null
        );
    }
