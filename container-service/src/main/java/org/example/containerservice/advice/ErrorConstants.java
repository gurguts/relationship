...
final class ErrorConstants {
    ...
    static final String ERROR_CONTAINER_NOT_FOUND = "CONTAINER_NOT_FOUND";
    ...
    static final String MESSAGE_KEY_CONTAINER_NOT_FOUND = "container.notfound";
    static final String MESSAGE_KEY_JSON_ERROR = "json.error";
    static final String MESSAGE_KEY_SERVER_ERROR = "server.error";

    static final String MESSAGE_KEY_PREFIX_CONTAINER_ERROR = "container.error.%s";
