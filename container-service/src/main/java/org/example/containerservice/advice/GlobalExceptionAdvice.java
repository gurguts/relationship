...
import org.example.containerservice.models.dto.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleContainerException(@NonNull ContainerException ex, @NonNull Locale locale) {
        String errorCode = ex.getErrorCode();
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Container error: code={}, message={}", errorCode, exceptionMessage);
        
        String messageKey = String.format(ErrorConstants.MESSAGE_KEY_PREFIX_CONTAINER_ERROR, errorCode.toUpperCase());
    ...
    public ErrorResponse handleContainerNotFoundException(@NonNull ContainerNotFoundException ex, @NonNull Locale locale) {
        String exceptionMessage = Objects.toString(ex.getMessage(), "");
        logRequestContext("Container not found: {}", exceptionMessage);
        return new ErrorResponse(
                ErrorConstants.ERROR_CONTAINER_NOT_FOUND,
                MessageLocalizationHelper.getLocalizedMessage(
                        messageSource, ErrorConstants.MESSAGE_KEY_CONTAINER_NOT_FOUND,
