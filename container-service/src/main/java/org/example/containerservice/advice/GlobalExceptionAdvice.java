...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleContainerNotFoundException(ContainerNotFoundException ex, Locale locale) {
        log.warn("Container not found: {}", ex.getMessage());
        return new ErrorResponse(
                "CONTAINER_NOT_FOUND",
                messageSource.getMessage("container.notfound", null, ex.getMessage(), locale),
                null
        );
    }
