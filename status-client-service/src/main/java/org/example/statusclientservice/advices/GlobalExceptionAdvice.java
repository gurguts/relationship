package org.example.statusclientservice.advices;
...
import org.example.statusclientservice.models.dto.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleStatusClientException(StatusClientException ex, Locale locale) {
        ...
        String message = messageSource.getMessage(
                "statusClient.error." + ex.getErrorCode().toUpperCase(),
                null,
                ex.getMessage(),
                locale
        );
