package org.example.transactionservice.advice;
...
import org.example.transactionservice.models.dto.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleTransactionException(TransactionException ex, Locale locale) {
        ...
        String message = messageSource.getMessage(
                "transaction.error." + ex.getErrorCode().toUpperCase(),
                null,
                ex.getMessage(),
                locale
        );
