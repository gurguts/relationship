package org.example.transactionservice.spec;
            ...
            if (filters.containsKey("created_at_from") || filters.containsKey("created_at_to")) {
                ...
                if (filters.containsKey("created_at_from")) {
                    ...
                    if (!fromDates.isEmpty()) {
                        try {
                            LocalDate date = LocalDate.parse(fromDates.get(0), DateTimeFormatter.ISO_LOCAL_DATE);
                ...
                if (filters.containsKey("created_at_to")) {
                    ...
                    if (!toDates.isEmpty()) {
                        try {
                            ...
                            System.err.println("Неверный формат created_at_to: " + toDates.getFirst());
                        }
                    }
                }
