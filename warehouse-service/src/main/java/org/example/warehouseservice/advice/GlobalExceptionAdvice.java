package org.example.warehouseservice.advice;
...
import org.example.warehouseservice.exceptions.WarehouseNotFoundException;
import org.example.warehouseservice.models.dto.ErrorResponse;
...
public class GlobalExceptionAdvice {
    ...
    public ErrorResponse handleWarehouseException(WarehouseException ex, Locale locale) {
        ...
        String message = messageSource.getMessage(
                "warehouse.error." + ex.getErrorCode().toUpperCase(),
                null,
                ex.getMessage(),
                locale
        );
